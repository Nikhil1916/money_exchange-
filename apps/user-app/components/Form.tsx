...
import { callOtp } from "../app/helpers/functions";
          ...
          <div>
            ...
            {!isPhoneNumberValid && (
              <p className="ml-1 mt-1 text-xs text-red-400 text-left flex items-center">
               <span className="mb-[1px] pr-[1px]"><ErrorIcon sx={{fontSize:'16px'}} /></span> Phone Number Not Valid
              </p>
            )}
             <p>
        {firstPage+"1"}
...

          {
            ...
            (
              <div>
                ...
                onWheel={handleWheel}
                type="OTP"
                className={"w-52 no-arrows border border-gray-400 rounded-md p-2 text-xs "+ ` ${isOtpError ? "" : "border border-red-400"}`}
              ...
              />
              
                {
                  !isOtpError && 
                  <p className="ml-1 mt-1 text-xs text-red-400 text-left flex items-center">
                   <span className="mb-[1px] pr-[1px]"><ErrorIcon sx={{fontSize:'16px'}} /></span> Otp Not Valid
                </p>
                }
         ...
         {
            ((firstPage && isSignIn) || (!thirdPage && !isSignIn)) && <Button
            className={
          ...
          {
            ((secondPage && isSignIn) || (thirdPage && !isSignIn)) &&  <Button
            className={
